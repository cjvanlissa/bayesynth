...
The example below illustrates this princuple.
Each analysis has two hypotheses in common, but also contains one sample-specific hypothesis.
The `pbf()` function is called on the resulting `bain` object and returns output for the two common hypotheses.
