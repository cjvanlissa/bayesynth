...
Both quantitative [REF] and qualitative [REF TMSR] research synthesis methods exist, but the present paper focuses on quantitative methods.

A key challenge in quantitative research synthesis is dealing with between-studies heterogeneity.
...
Meta-analysis is the most common research synthesis method.
...
exploratory techniques like random forest meta-analysis and penalized meta-regression can be used to identify relevant moderators.
