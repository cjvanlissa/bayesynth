...
Figure \@ref(fig:figk) indicates that, for PBF at higher levels of $k$,
...
```{r, eval = FALSE, echo = FALSE, results = resultaction}
...
# Test the hypothesis that the effect size labeled 'beta' is positive
bf_tot <- pbf(results, hypothesis = "beta > .1", standardize = TRUE)
```
